...
- Made `trigger` frontmatter field optional in the skill validator to support Claude Code skill format (#67)
- Updated standalone app

### Fixed

- Added Windows compatibility to launcher script (#65)
- Fixed lint issues
- Updated validator tests to match optional trigger field
...
[0.10.1]: https://github.com/uberskillsdev/uberskills/releases/tag/v0.10.1
